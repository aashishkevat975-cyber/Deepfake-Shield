...
export default function App() {
  ...
  const handleCheckScam = () => {
    showInterstitial(); // Ad show hoga jab user check karega
    if (!message.trim()) {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      {/* SBI Loan Section */}
      <TouchableOpacity style={styles.yellowCard} onPress={() => Linking.openURL('https://www.onlinesbiloan.com')}>
